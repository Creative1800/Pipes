...
public class ScoreServiceJDBC implements ScoreService {
    ...
    public void addScore(Score score) {
        try (Connection connection = DriverManager.getConnection(ServerUUP.URL, ServerUUP.USER, ServerUUP.PASSWORD);
            ...
            throw new sk.tuke.gamestudio.game.pipes.service.ScoreException("Problem adding score", e);
        }
    }
    ...
    public List<Score> getTopScores(String game) {
        try (Connection connection = DriverManager.getConnection(ServerUUP.URL, ServerUUP.USER, ServerUUP.PASSWORD);
            ...
            throw new sk.tuke.gamestudio.game.pipes.service.ScoreException("Problem getting top scores", e);
        }
    }
